...
OUTPUT_FOLDER = "xgb_model_artifacts_long"

INPUT_COLUMNS = ['Irradiation', 'Temp', 'Wind', 'Humidity']
OUTPUT_COLUMN = 'TOAL ACTIVE POWER [MW]'

LAG_MINUTES = 120        # past 120 minutes (2 hours)
PREDICTION_STEP = 60     # predict 60 minutes ahead (1 hour)
...
def main():
    ...
    print("Starting XGBoost long-term training pipeline")
    ...
    # --------------------------------------------------
    model_path = os.path.join(OUTPUT_FOLDER, "xgb_model_1hr.pkl")
    config_path = os.path.join(OUTPUT_FOLDER, "feature_config_1hr.pkl")
    ...
    plt.title("XGBoost – 1 Hour Ahead Power Prediction")
    plt.xlabel("Time")
    ...
    print("\nLong-term training pipeline completed successfully")
