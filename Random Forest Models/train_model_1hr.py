# =========================================
# RANDOM FOREST – 60 MINUTE (1 HOUR) FORECAST
# =========================================
...
# Target (60 min ahead)
# -----------------------------
train_data['Target'] = train_data['TOTAL_ACTIVE_POWER'].shift(-60)
test_data['Target'] = test_data['TOTAL_ACTIVE_POWER'].shift(-60)
...
# Save Model
# -----------------------------
dump(rf, "RandomForest_60min.joblib")
print("Model saved as RandomForest_60min.joblib")
